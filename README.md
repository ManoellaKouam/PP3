...
<details>
    ...
    hier wird ein PDF-Datei erstellt 
</details>

<details>
    <summary>How do you change the name of the pdf-file?</summary>
   man muss die synthaxe hier bearbeiten: pdflatex -jobname= namedespdf.pdf main.tex
</details>
...
<details>
    ...
    Die Klasse Book erzeugt standardmäßig eine eigene Titelseite, während article alles auf derselben Seite darstellt.
    in book beginnt die eigentliche Nummerierung nach dem Titelblatt.
</details>
<details>
    <summary>What changes in your pdf, if you add <code>\section{Intro}</code> after <code>\maketitle</code></summary>
    eine neue section wird hingefügt
</details>
...
<details>
  ...
  Der Text wird größer und fett angezeigt
</details>

<details>
    <summary>How can you generate a listing of items?</summary>
     Es gibt zwei Möglichkeiten, eine Liste zu deklarieren. Eine Liste kann entweder geordnet oder ungeordnet deklariert werden. Das ist ein beispiel von ungeordnet liste
    <code>
    <ul>
         <li>element1 </li>
         <li>element2 </li>
